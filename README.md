...
Un *analizador de texto* es una aplicación para extraer métricas útiles
de un texto para la toma de decisiones de los usuarios. Utiliza técnicas, 
como el procesamiento del lenguaje natural (NLP), el aprendizaje 
automático (ML) y el análisis estadístico.
